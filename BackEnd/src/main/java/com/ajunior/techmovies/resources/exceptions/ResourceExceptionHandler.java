package com.ajunior.techmovies.resources.exceptions;
...
import com.ajunior.techmovies.services.exceptions.DataBaseException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> entityNotFound(ResourceNotFoundException e, HttpServletRequest request) {
		...
		err.setError("Resource notO found");
